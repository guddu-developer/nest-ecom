                ...
                <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="controls  ">
                                <select class="selectpicker form-control" id="enclose" data-style="btn-info" data-max-options="1" data-live-search="true" name="parent">
                                    <?php foreach ($product as $c) { ?>
                                        <option value="<?= $c->id; ?>" <?php if($d->product_id==$c->id){ echo "selected"; } ?> ><?= $c->heading; ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="control-group ">
                            ...
                            <div class="controls">
                                ...
                                <label for="deal" style="margin: 20px;">
                                    <input type="checkbox" id="deal" name="deal" value="1"  <?php if($d->deal==1) { echo "checked"; } ?>>DEAL OF THE DAY
                                </label>

                                <label for="pop" style="margin: 20px;">
                                    <input type="checkbox" id="pop" name="sell" value="1" <?php if($d->top_selling==1) { echo "checked"; } ?>>TOP SELLING
                                </label>


                                <label for="sale" style="margin: 20px;">
                                    <input type="checkbox" id="sale" name="trend" value="1"  <?php if($d->trending==1) { echo "checked"; } ?> >TRENDING
                                </label>


                                <label for="hot" style="margin: 20px;">
                                    <input type="checkbox" id="hot" name="rate" value="1"  <?php if($d->top_rated==1) { echo "checked"; } ?> >TOP RATED
                                </label>
                        ...
                        <div class="control-group ">
                            ...
                            <div class="controls">
                                <select name="status" class="form-control">
                                    ...
                                    <option value="1" <?php if($d->status==1) { echo "selected"; } ?> >Active</option>
                                    <option value="0" <?php if($d->status==0) { echo "selected"; } ?> >Inactive</option>
                                </select>
                                <font color="#FF0000"><?php if ($this->input->post("add") == 1) {
                 ...
                 <?php endforeach; ?>
                    ...
                    <div class="form-actions ajax-spinner" style="padding-top: 30px;">
                        ...
                        <button type="button" class="btn btn-warning" onclick="window.location.href='<?= base_url('deal'); ?>'">Back</button>
