...
<head>
    <title>NEST:PRIVACY-POLICY</title>
                            ...
                            <div class="col-lg-9">
                                <div class="single-page pr-30 mb-lg-0 mb-sm-5">
                                    ...
                                    <div class="single-content mb-50">
                                        <h4>Welcome to NEST Privacy Policy</h4>
                                        <ol start="1">
                                        ...
                                        <ol start="17">
                                            <li>For more information about how we use cookies, web beacons and similar technologies see our cookie policy <a href="">here</a> and for more general information on cookies, see <a href="" rel="noopener noreferrer">http://www.allaboutcookies.org</a>.</li>
                                            <li>
                                            ...
                                            <li>Occasionally, we will use third party advertising companies to serve ads based on prior visits to our Sites. For example, if you visit our Sites, you may later see an add for our products and services when you visit a different Site. Read more about your options in our <a href="">cookie policy</a>.</li>
                                        </ol>
                                        ...
                                        <ol start="25">
                                            <li>If you have any questions about our privacy practices or the way in which we have been managing your personal information, please contact our privacy champion in writing at PO Box 16122 Collins Street West Victoria 8007 Australia or <a href=""><span class="__cf_email__">Nest.com</span></a>.</li>
                ...
                <?php endforeach;?>
                   ...
                   <?php foreach($latest as $l): ?>
                                      ...
                                      foreach($product_image as $img):
                                               ...
                                               echo base_url('media/images/product/').$img->images;break; }
                                                endforeach;
                                                ?>" alt="#" />
                                            </div>
