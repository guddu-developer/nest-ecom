...
<head>
    ...
    <title>NEST : PRODUCT-DETAILS</title>
</head>
                            ...
                            <div class="row mb-50 mt-30">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-info pr-30 pl-30">
                                        ...
                                        <h2 class="title-detail"><?= $p->heading; ?></h2>
                                                    ...
                                                    if ($cat->id == $exp) {
                                                        echo '<a href="' . base_url('category/') . $cat->url . '">' . $cat->category . "</a> | ";
                                                            ...
                                                            <div class="product-card-bottom">
                                                                ...
                                                                <div class="add-cart">
                                                                    <a class="add" href="javascript:void(0)" data-id="<?= $ap->id; ?>" data-heading="<?= $ap->heading; ?>" data-price="<?= $ap->selling_price; ?>" data-quantity="1" data-image="<?php foreach ($product_image as $pimg) :  if ($ap->id == $pimg->product_id) {
                                                                                                                                                                                                                                                            echo  base_url("media/images/product/") . $pimg->images;
                                                                                                                                                                                                                                                            break;
                                                                                                                                                                                                                                                        }
